...
public class CheapNightsDbContext(DbContextOptions<CheapNightsDbContext> options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<GameEntry>().HasData(
            ...
            // Classic games
            new GameEntry { Id = 29, GroupId = 1, SortOrder = 20, Name = "RE HD REMASTER (2015)", CategoryId = 1, EntryTypeId = 1, Protagonist = "Chris / Jill", StoryEra = "1998", StatusId = 2, StarRating = 2, LengthLabel = "10h", SortLabel = "7", GameNote = "HD remaster of the 2002 GameCube remake — the definitive version of the original Spencer Mansion story until the new remake lands" },
            new GameEntry { Id = 30, GroupId = 1, SortOrder = 21, Name = "RE0 HD REMASTER", CategoryId = 1, EntryTypeId = 1, Protagonist = "Rebecca + Billy", StoryEra = "1998", StatusId = 3, StarRating = 1, LengthLabel = "12h", SortLabel = "7b", GameNote = "Prequel — Rebecca & Billy on the Ecliptic Express the night before RE1. Adds context but not essential to the main arc" },
            new GameEntry { Id = 31, GroupId = 1, SortOrder = 22, Name = "RE4 ORIGINAL (2005)", CategoryId = 1, EntryTypeId = 1, Protagonist = "Leon S. Kennedy", StoryEra = "2004", StatusId = 3, StarRating = 3, LengthLabel = "16h", SortLabel = "—", GameNote = "The original that redefined the genre — play if you want to compare with the remake or experience the campier tone" },

            // Live-action films (Paul W.S. Anderson series + Welcome to Raccoon City)
            new GameEntry { Id = 32, GroupId = 1, SortOrder = 30, Name = "RESIDENT EVIL (2002)", CategoryId = 1, EntryTypeId = 2, Protagonist = "Alice (Milla Jovovich)", StoryEra = "2002", StatusId = 3, StarRating = 2, LengthLabel = "1.5h", IsMovie = true, GameNote = "The Hive, T-virus outbreak, Red Queen — started the film franchise. Loosely inspired by the games" },
            new GameEntry { Id = 33, GroupId = 1, SortOrder = 31, Name = "RE: APOCALYPSE (2004)", CategoryId = 1, EntryTypeId = 2, Protagonist = "Alice + Jill Valentine", StoryEra = "2004", StatusId = 3, StarRating = 1, LengthLabel = "1.5h", IsMovie = true, GameNote = "Raccoon City outbreak with Nemesis — introduces Jill and Carlos from the games" },
            new GameEntry { Id = 34, GroupId = 1, SortOrder = 32, Name = "RE: EXTINCTION (2007)", CategoryId = 1, EntryTypeId = 2, Protagonist = "Alice", StoryEra = "2007", StatusId = 3, StarRating = 1, LengthLabel = "1.5h", IsMovie = true, GameNote = "Post-apocalyptic desert wasteland — Alice convoy vs Umbrella. Claire Redfield joins" },
            new GameEntry { Id = 35, GroupId = 1, SortOrder = 33, Name = "RE: AFTERLIFE (2010)", CategoryId = 1, EntryTypeId = 2, Protagonist = "Alice + Claire + Chris", StoryEra = "2010", StatusId = 3, StarRating = 1, LengthLabel = "1.5h", IsMovie = true, GameNote = "Los Angeles prison siege — Wesker showdown. First in 3D" },
            new GameEntry { Id = 36, GroupId = 1, SortOrder = 34, Name = "RE: RETRIBUTION (2012)", CategoryId = 1, EntryTypeId = 2, Protagonist = "Alice + Ada + Leon", StoryEra = "2012", StatusId = 3, StarRating = 1, LengthLabel = "1.5h", IsMovie = true, GameNote = "Umbrella simulation facility — Ada Wong and Leon join. Most game-character-heavy entry" },
            new GameEntry { Id = 37, GroupId = 1, SortOrder = 35, Name = "RE: THE FINAL CHAPTER (2016)", CategoryId = 1, EntryTypeId = 2, Protagonist = "Alice", StoryEra = "2016", StatusId = 3, StarRating = 1, LengthLabel = "1.5h", IsMovie = true, GameNote = "Return to the Hive — wraps up the Anderson/Jovovich saga" },
            new GameEntry { Id = 38, GroupId = 1, SortOrder = 36, Name = "RE: WELCOME TO RACCOON CITY (2021)", CategoryId = 1, EntryTypeId = 2, Protagonist = "Claire + Leon + Chris", StoryEra = "2021", StatusId = 3, StarRating = 2, LengthLabel = "1.5h", IsMovie = true, GameNote = "Faithful reboot combining RE1 + RE2 — Spencer Mansion and RPD in one night. Closer to the games than the Anderson films" },
